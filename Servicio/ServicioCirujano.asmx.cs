...
namespace Servicio
{
    ...
    public class ServicioCirujano : WebService
    {
        ...
        /// <returns></returns>
        [WebMethod]
        public List<Cirujano> ObtenerTodosCirujanos()
        {
            LCirujano logica = new LCirujano();
            return logica.ObtenerCirujanos();
        }
        ...
        {
            LCirujano logica = new LCirujano();
            return logica.AgregarCirujano(cirujano);
        }
        ...
        {
            LCirujano logica = new LCirujano();
            return logica.ObtenerCirugiasAgregarCirujano(cirujano);
        }
