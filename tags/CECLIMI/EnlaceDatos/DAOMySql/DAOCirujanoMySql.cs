...
namespace EnlaceDatos.DAOMySql
{
    ...
    public class DAOCirujanoMySql: ConexionMySql, IDAOCirujano
    {
        ...
        /// <returns></returns>
        public List<Cirujano> ObtenerCirujanosCirugia(Entidad cirugia)
        {
        ...
        public List<Cirugia> ObtenerCirugiasAgregarCirujano(Cirujano cirujano)
        {
            ...
            try
            {
                ...
                comando.Connection = Conexion();
                comando.CommandType = CommandType.StoredProcedure;
                comando.CommandText = "ObtenerCirugiasAgregarCirujano";
                ...
                while (reader.Read())
                {
                    ...
                    cirugia.Id = reader.GetInt32(0);
                    cirugia.Nombre = reader.GetString(1);
                    retorno.Add(cirugia);
                }
        ...
        /// <summary>
        /// ObtieneLosCirujanos de la clinica
        /// </summary>
        /// <returns></returns>
        public List<Cirujano> ObtenerCirujanos()
        {
            ...
            try
            {
                ...
                comando.Connection = Conexion();
                comando.CommandType = CommandType.StoredProcedure;
                comando.CommandText = "ObtenerCirujanos";

                MySqlDataReader reader = comando.ExecuteReader();
                while (reader.Read())
                {
                    Cirujano cirujano = new Cirujano();
                    cirujano.Id = reader.GetUInt32(0);
                    cirujano.Nombre = reader.GetString(1);
                    retorno.Add(cirujano);
                }
